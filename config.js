...
module.exports = {
    ...
    ownerNumber: ['923478936242'], // Add your number without + or spaces (e.g., 919876543210)
    ...
    updateZipUrl: 'https://github.com/foraivelloging-cmd/SAQIB-MD/archive/refs/heads/main.zip', // URL to latest code zip for .update command
